...
apt-get update && \
apt-get upgrade -y && \
BUILD_PACKAGES="supervisor mysql-server mysql-client nginx php5-fpm git php5-mysql php-apc php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-pgsql php5-mongo php5-ldap pwgen" && \
...
# Setup Volume
VOLUME ["/home/ubuntu/sites/laravel"]
ADD src/ /home/ubuntu/sites/laravel
RUN chown -Rf www-data.www-data /home/ubuntu/sites/laravel/
...
# Set permissions to Laravel Framework and running migrations
